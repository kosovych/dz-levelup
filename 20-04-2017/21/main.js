...
if (user1 > 21) {
	console.log(`Вы проиграли. Ваше число больше ${user1} и оно больше 21`);
} else {
	var user2 = randomNumb();
};

if (user1 > user2) {
	console.log("Первый игрок выиграл. Поздравляем!");
} else if (user1 < user2) {
	console.log("Второй игрок выиграл. Поздравляем!");
